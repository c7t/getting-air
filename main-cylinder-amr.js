...
async function init() {
  ...
  // TEMPORARY diagnostic: isolate each level's own force-pass contribution
  // (does NOT advance state -- forceBuf is explicitly zeroed before each
  // pass, no phy/step dispatch at all) to bisect a Milestone-10 Cd
  // regression at N=3 down to a single level's pass.
